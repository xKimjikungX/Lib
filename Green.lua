...
function create:Win()
    ...
    UIGradient_PageTap.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 255, 123)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 35, 138))}
...
function tap:addtap(text)
    ...
    TextLabel_Tap.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
    ...
    TextLabel_Tap.Text = " "
    TextLabel_Tap.TextColor3 = Color3.fromRGB(0, 255, 123)
    ...
    ScolPage.ScrollBarImageColor3 =  Color3.fromRGB(0, 255, 123)
...
function page:addpage()
    ...
    Page.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
...
function ems:Button(text,callback)
    ...
    TextLabel_emsTextButton.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
    ...
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(0, 255, 123)
    ...
    MheeFrameStroke.Color = Color3.fromRGB(0, 255, 123)
    ...
    --    if joincheck.check1 == false then
            ...
            TweenService:Create(
                ...
                {BackgroundColor3 =  Color3.fromRGB(0, 255, 123)} -- UDim2.new(0, 128, 0, 25)
            ):Play()
--     end
...
function ems:Slder(text,min,max,de,callback)
    ...
    SlisFrameStroke.Color = Color3.fromRGB(0, 255, 123)
    ...
    TalabelSlider.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
    ...
    MainValue.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
...
function ems:Ti(text)
    ...
    lineframe.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
    ...
    lineframe2.BackgroundColor3 = Color3.fromRGB(0, 255, 123)
    ...
    lineframe3.TextColor3 = Color3.fromRGB(100, 255, 167)
